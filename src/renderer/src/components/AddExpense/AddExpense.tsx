...
export const AddExpense: React.FC<AddNewSupplierProps> = ({ closeSidebarNew }) => {
    ...
    const handelSubmit = () => {
        ...
        if (Number(bankBalance) < Number(amount)) {
            ...
            try {
                axios
                    .post(import.meta.env.VITE_API_URL + '/expense/addExpense',
                        {
    ...
    return (
        <div>
            <ToastContainer />
            <div><p><b className='text-[1.2rem]'>Add Expense</b></p></div>
                ...
                <div className='m-5'>
                    ...
                    <div className='flex justify-around py-2' >
                        ...
                        <div className='flex flex-col w-[45%]'>
                            ...
                            <InputNumber placeholder='Enter Amount' inputId="currency-india" value={amount} required onValueChange={(e) => setAmount(e.value)} mode="currency" currency="INR" currencyDisplay="symbol" locale="en-IN" />
                        </div>
                        <div className='flex flex-col w-[45%]'>
                    ...
                    <div className='flex justify-around py-2' >
                        ...
                        <div className='flex flex-col w-[40%]'>
                            <button className='bg-[green] py-2 text-[white] rounded-lg' type='submit'>Store Expense</button>
                        </div>
