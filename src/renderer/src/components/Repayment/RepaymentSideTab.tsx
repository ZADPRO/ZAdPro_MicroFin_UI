                        ...
                        </div>
                        {
                            ...
                            <>
                                ...
                                <div className="m-3 w-full flex ">
                                    ...
                                    <div className="w-[30%]">
                                        <p>Loan Start Month : {loanDetails.refRepaymentStartDate ? formatToFirstOfMonth(loanDetails.refRepaymentStartDate) : " -"}</p>
                                    </div>
                                    <div className="w-[30%]">
                    ...
                    <TabView
                        ...
                        <TabPanel header="Re-Payment">
                            ...
                            <div className="my-0 w-full">
                                ...
                                <form
                                    onSubmit={(e) => { e.preventDefault(), updateRepayment() }}
                                    className="w-full">
                                    ...
                                    <div className="w-[100%] flex flex-col align-items-center gap-3">
                                        ...
                                        <div className="flex flex-col w-[60%]">
                                            <label htmlFor="Principal" className="font-bold block mb-2">Payment Type</label>

                                            <div className="flex flex-start gap-3">
                                                <div className="flex align-items-center">
                                                    <RadioButton required inputId="ingredient1" name="pizza" value="online" onChange={(e: RadioButtonChangeEvent) => setPaymentType(e.value)} checked={paymentType === 'online'} />
                                                    <label htmlFor="ingredient1" className="ml-2">Online</label>
                                                </div>
                                                <div className="flex align-items-center">
                                                    <RadioButton required inputId="ingredient2" name="pizza" value="cash" onChange={(e: RadioButtonChangeEvent) => setPaymentType(e.value)} checked={paymentType === 'cash'} />
                                                    <label htmlFor="ingredient2" className="ml-2">Cash</label>
                                                </div>
                                            </div>
                                        </div>
                                        {
                                            ...
                                            <div className="w-[60%]">
                                                ...
                                                }} options={bankOption} optionLabel="label"
                                                    placeholder="Select a Bank" className="w-full" checkmark={true} highlightOnSelect={false} />
                                            </div>
                                        }

                                        <button type="submit" className=" bg-[green] hover:bg-[#008000f3] text-white p-2 px-5 rounded-lg">Payment Collected</button>
                                    </div>
                        ...
                        <TabPanel header="Follow up">
                            <form className="" onSubmit={(e) => {
                                ...
                                <div className="w-[100%] flex flex-col justify-center align-items-center">
                                    <div className="w-[60%]">
                                        <label htmlFor="Message" className="font-bold block mb-2">Comment Given By User</label>
                                        <InputTextarea required className="h-full" placeholder="Type your Message Here" value={followUpForm.Message} onChange={(e) => setFollowUpForm({ ...followUpForm, Message: e.target.value ?? "" })} rows={5} cols={30} />
                                    </div>
                                    <div className="w-[60%]">
                                        <label htmlFor="Date and Time" className="font-bold block mb-2">Date and Time Asked By the User</label>
                                        <Calendar required className="w-full" value={followUpForm.Date} onChange={(e) => setFollowUpForm({ ...followUpForm, Date: e.target.value ?? "" })} showTime hourFormat="12" />
                                    </div>
                                    <button type="submit" className="bg-[green] p-2 px-7 text-white my-3 rounded-lg hover:bg-[#008000f1]">
                                        Submit Message
                                    </button>
                                </div>
                            </form>
