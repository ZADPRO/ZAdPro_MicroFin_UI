...
const Customers = () => {
    ...
    const CustomerId = (rowData: any) => {
        ...
        }} style={{ color: "#f8d20f", textDecoration: "underline", cursor: "pointer" }}>{rowData.refCustId}</div></>)
    }
    ...
    return (
        <>
            ...
            {
                loadingStatus ? (   
                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", color: "#f8d20f", height: "92vh", width: "100%" }}>
                    ...
                    <div className="contentPage">
                        ...
                        <Button label="New Agents" severity="warning" style={{ backgroundColor: "#f8d20f" }} onClick={() => { setNewData(true) }} />
                        ...
                        <div>
                            <DataTable filters={filters} paginator rows={4} value={userLists} showGridlines scrollable emptyMessage={<div style={{ textAlign: 'center' }}>No Records Found</div>} tableStyle={{ minWidth: '50rem', overflow: "auto" }}>
