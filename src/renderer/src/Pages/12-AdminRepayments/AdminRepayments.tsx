            ...
            {loadingStatus ? (
                ...
                <div className=" w-full h-[75vh]">
                    <div
                        ...
                        className='flex flex-row align-items-center justify-end w-full'
                    >
                    ...
                    <div>
                        ...
                        >
                            ...
                            <Column
                                ...
                                header="Phone Number"
                            ></Column>
                            <Column style={{ minWidth: '10rem' }} field='refUserAddress' header="Address"></Column>
                            ...
                            <Column style={{ minWidth: '8rem' }} field="refLoanAmount" body={(rowData) => `₹ ${rowData.refLoanAmount}`} header="Principal Amount"></Column>
                        </DataTable>
                    </div>
