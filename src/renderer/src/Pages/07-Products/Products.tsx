...
const Products = () => {
    ...
    const CustomerId = (rowData: any) => {
        ...
        }} style={{ color: "#f8d20f", textDecoration: "underline", cursor: "pointer" }}>{rowData.refProductName}</div></>)
    }
            ...
            <Header userName={username} pageName={"Products"} />
            {
                loadingStatus ? (
                    ...
                    <div className="contentPage">
                        ...
                        <Button label="Add Products" severity="warning" style={{ backgroundColor: "#f8d20f" }} onClick={() => { setNewData(true) }} />
